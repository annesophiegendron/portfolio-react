    ...
    <SectionWrapperGrey id="personal-section">
      ...
      <Wrapper>
        ...
        "Your browser is not supported!"
          ...
          <Text><strong>Cubes animation</strong> using Three.js and the React renderer Three Fiber. See the <a href="https://github.com/annesophiegendron/cubes" target="_blank" rel="noopener noreferrer">source code here</a> or see the project live <strong><a href="https://cubes.annesophiegendron.vercel.app/" target="_blank" rel="noopener noreferrer">here</a></strong>.<br></br></Text>
        </PersonalContainer>
      </Wrapper>
